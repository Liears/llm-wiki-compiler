...
// ============================================================================
// Base Compiler Interfaces & Classes
// ============================================================================

// Re-export base compiler interfaces to avoid circular dependencies
export type { TopicCompiler, ConceptCompiler } from "./base";
export { BaseTopicCompiler, BaseConceptCompiler } from "./base";
...
// Re-export from wiki package where the actual implementation lives
export { MarkdownIndexBuilder, SchemaManager as FileSystemSchemaManager } from "./wiki";
